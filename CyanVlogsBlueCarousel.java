    ...
    public void runOpMode() {
       ...
       // webcam2 = OpenCvCameraFactory.getInstance().createWebcam(hardwareMap.get(WebcamName.class, "OpenCvCamera"), cameraMonitorViewId);
        ...
        if (opModeIsActive()) {
            ...
            //Backwards
            PIDController(new double[] {-0.25,-0.25,-0.25,-0.25}, new DcMotor[] {frontl,frontr,bottoml,bottomr}, new int[] {-355,-355,-355,-355});
            //strafe
            ...
            PIDController(new double[] {-0.25,0.25,-0.25,0.25}, new DcMotor[] {frontl,frontr,bottoml,bottomr}, new int[] {-325,325,-325,325});
            //Square Up
            frontl.setPower(-0.4);
            frontr.setPower(-0.4);
            ...
            //Head to hub
            PIDController(new double[] {0.25,0.25,0.25,0.25}, new DcMotor[] {frontl,frontr,bottoml,bottomr}, new int[] {290, 290, 290, 290});
            ...
            if ( a < b && a < c ) {
                ...
                PIDController(new double[] {1}, new DcMotor[] {ElevatorMotor}, new int[] {1000});
               // sleep(500);
              //  servo.setPower(-0.5);
             //   sleep(350);
             //   servo.setPower(0);
         ...
         //       sleep(350);
           //     servo.setPower(0);
            ...
            if (c<a && c<b) {
                ...
                PIDController(new double[]{1}, new DcMotor[]{ElevatorMotor}, new int[]{6500});
            }
            ...
            if (location != "c") {
                //Go forward
                PIDController(new double[] {.3, .3, .3, .3}, new DcMotor[] {frontl,frontr,bottoml,bottomr}, new int[] {75, 75, 75, 75});
