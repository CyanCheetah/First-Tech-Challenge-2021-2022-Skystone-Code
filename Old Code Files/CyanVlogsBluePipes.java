...
@Autonomous
public class CyanVlogsBluePipes extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            //Backwards
            PIDController(new double[] {-0.25,-0.25,-0.25,-0.25}, new DcMotor[] {frontl,frontr,bottoml,bottomr}, new int[] {-600,-600,-600,-600});
            //strafe
            ...
            int _temp183 = 225;
            //Head to hub
            PIDController(new double[] {0.25,0.25,0.25,0.25}, new DcMotor[] {frontl,frontr,bottoml,bottomr}, new int[] {_temp183, _temp183, _temp183, _temp183});
