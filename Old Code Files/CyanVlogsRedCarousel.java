...
@Autonomous
public class CyanVlogsRedCarousel extends LinearOpMode {
    ...
    public void runOpMode() {
       ...
       // webcam2 = OpenCvCameraFactory.getInstance().createWebcam(hardwareMap.get(WebcamName.class, "OpenCvCamera"), cameraMonitorViewId);
        ...
        if (opModeIsActive()) {
            ...
            //Backwards
            PIDController(new double[] {-0.25,-0.25,-0.25,-0.25}, new DcMotor[] {frontl,frontr,bottoml,bottomr}, new int[] {-650,-650,-650,-650});
            //strafe
           ...
           // PIDController(new double[] {-0.1,-0.1,-0.1,-0.1}, new DcMotor[] {frontl,frontr,bottoml,bottomr}, new int[] {-100,-100,-100,-100});
            //Head to hub
            PIDController(new double[] {0.25,0.25,0.25,0.25}, new DcMotor[] {frontl,frontr,bottoml,bottomr}, new int[] {400, 400, 400, 400});
            ...
            if (c<a && c<b) {
                ...
                //PIDController(new double[] {0.25}, new DcMotor[] {ElevatorMotor}, new int[] {100});
